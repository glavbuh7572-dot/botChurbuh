...
# 1) Токен бота. Получите у @BotFather, вставьте между кавычек.
BOT_TOKEN = "СЮДА_ВСТАВЬТЕ_ТОКЕН"
...
def main():
    if BOT_TOKEN == "СЮДА_ВСТАВЬТЕ_ТОКЕН":
        raise SystemExit("❌ Сначала впишите токен бота в переменную BOT_TOKEN.")
